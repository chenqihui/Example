...
#define _IMAGE_MIC_NORMAL  [UIImage imageNamed:@"img_record_one.png"]
#define _IMAGE_MIC_TALKING [UIImage imageNamed:@"img_record_nine.png"]
#define _IMAGE_MIC_WAVE [UIImage imageNamed:@"img_record_progress.png"]
