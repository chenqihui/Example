...
- (void)initializer {
    ...
    UIScrollView *cellScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(20, 0, CGRectGetWidth(self.bounds) - 20, _height)];
    cellScrollView.contentSize = CGSizeMake(CGRectGetWidth(self.bounds) + [self utilityButtonsPadding] - 20, _height);
    cellScrollView.contentOffset = [self scrollViewContentOffset];
    cellScrollView.delegate = self;
    cellScrollView.showsHorizontalScrollIndicator = NO;
    [cellScrollView setBackgroundColor:[UIColor greenColor]];
